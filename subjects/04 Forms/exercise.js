...
class CheckoutForm extends React.Component {
  state = {
    billingName: "Babe Ruth",
      billingState: "ND",
      shippingSameAsBilling: false,
      shippingName: "Martha Washington",
      shippingState: "WA"
  };
      ...
      <div>
        ...
        <form
          ...
          <fieldset>
            ...
            <p>
              <label>
                Billing Name: <input type="text" name="billingName" defaultValue={this.state.billingName}
                                     onChange={event => this.setState({billingName: event.target.value})}/>
              </label>
            </p>
            <p>
              <label>
                Billing State: <input type="text" size="2" name="billingState"
          ...
          <fieldset>
            <label>
              <input type="checkbox"
              onChange={event => this.setState({shippingSameAsBilling: event.target.checked})}/> Same as billing
            </label>
